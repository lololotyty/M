...
async def help(bot, message, cb=False):
    ...
    button = [[
        ...
        InlineKeyboardButton(f'📦 SOURCE', url='https://github.com/codewithevilxd/MegaDL-Bot'),
...
async def start(bot, message, cb=False):
    ...
    owner_username = owner.username if owner.username else 'codewithevilxd'
    button = [[
    ...
    if Config.UPDATES_CHANNEL:
        ...
        try:
            ...
            if user.status == "kicked":
                await message.message.edit(
                    text="Sorry Sir, You are Banned. Contact My [Support Group](https://t.me/alien1104).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await message.message.edit(
                text="Something Went Wrong. Contact My [Support Group](https://t.me/Alien1104).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
